...
# TODO: Ensure this is the correct GitHub homepage where releases can be downloaded for stackitcli.
...
list_all_versions() {
	...
	# Change this function if stackitcli has other means of determining installable versions.
	list_github_tags
}
